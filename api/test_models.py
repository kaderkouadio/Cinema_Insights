...
# les database.py et models.py  nous permettent de nous connecter a la base de donnees
# ce fichier test_models.py nous permet de tester les classes 
...
# %%
# Chaque élément est maintenant un tuple (title, rating)
for title, rating in high_rated_movies:
    print(title, rating)
